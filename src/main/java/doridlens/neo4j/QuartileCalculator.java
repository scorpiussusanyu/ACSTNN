...
public class QuartileCalculator {
    ...
    public void calculateClassComplexityQuartile() throws IOException {
        ...
        try (Transaction ignored = graphDatabaseService.beginTx()) {
            String query = "MATCH (n:Class) WHERE NOT HAS(n.is_interface) AND NOT EXISTS(n.is_abstract) RETURN percentileCont(n.class_complexity,0.25) as Q1, percentileCont(n.class_complexity,0.5) as MED, percentileCont(n.class_complexity,0.75) as Q3";
